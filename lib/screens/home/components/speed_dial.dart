  ...
  return SpeedDial(
    ...
    children: [
      SpeedDialChild(
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => const CadastrarTransacao(tipoTransacao: 1)));
        },
        label: 'Entrada',
        labelStyle:
      ...
      SpeedDialChild(
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => const CadastrarTransacao(tipoTransacao: 2)));
        },
        label: 'Saida',
        labelStyle:
            const TextStyle(fontWeight: FontWeight.w500, color: Colors.white),
      ...
      SpeedDialChild(
        ...
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (_) => CadastrarContaScreen()));
        },
        label: 'Conta',
        labelStyle:
            const TextStyle(fontWeight: FontWeight.w500, color: Colors.white),
